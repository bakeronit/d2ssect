...
def get_names(target_dir: str) -> list:
    ...
    for target_file in target_files:
        ...
        gene_names.extend(re.findall('[A-Z]+-[0-9]+-[0-9]+_S[0-9]+|[A-Z]+_[0-9]+_S[0-9]+',target_file))
        #gene_names.extend(re.findall('[A-Z]+[0-9]*_[M,C,S]*[0-9]*_[0-9]{3}',target_file))
...
def get_gene_ids_from_path(result_path: str) -> List[str]:
    ...
    return re.findall('[A-Z]+-[0-9]+-[0-9]+_S[0-9]+|[A-Z]+_[0-9]+_S[0-9]+',result_path)
    #return re.findall('[A-Z]+[0-9]*_[M,C,S]*[0-9]*_[0-9]{3}',result_path)
